...
//==============================================================
// Constantes del PD
float KD = 13.5;  // Constante derivativa PID
float KP = 10.0;  // Constante proporcional PID
...
void move_robot() {
  ...
  m_izq_speed = constrain(base_speed + motorSpeed, 100, max_speed);
  m_der_speed = constrain(base_speed - motorSpeed, 100, max_speed);
